  ...
  return (
      <HelmetProvider>
        <QueryClientProvider client={queryClient}>
          ...
          <Route path="/en/institution-detail/:id" element={<InstitutionDetailPage />} />
          <Route path="/en/partner-benefits" element={<InstitutionDetailPage />} />
          <Route path="/en/institution-application" element={<InstitutionApplication />} />
          ...
          <Route path="/en/family" element={<ChildPackage />} />
          ...
          <Route path="/en/iep-view/:id" element={<IEPView />} />
          <Route path="/en/wellness-lifestyle" element={<WellnessLifestyle />} />
          <Route path="/en/ir-deck" element={<IRDeck />} />
          <Route path="/en/platform-summary" element={<PlatformOnePager />} />
          <Route path="/en/b2b-proposal" element={<B2BProposal />} />
          <Route path="/en/startup-package" element={<StartupPackage />} />
