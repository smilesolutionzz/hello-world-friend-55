...
const ClientLogos = () => {
  ...
  const partners = [
    ...
    { 
      ...
      location: "경기도 남양주시",
      phone: "031-1234-5678",
      services: ["언어지원", "인지지원", "작업지원", "사회성훈련", "부모상담"],
      specialties: ["자폐스펙트럼", "ADHD", "언어발달지연", "학습장애"],
      rating: 4.7,
      description: "아동발달 전문센터로 언어지원, 인지지원, 작업지원을 통합적으로 제공합니다.",
      hours: "평일 09:00-18:00, 토요일 09:00-15:00"
    },
    { 
      name: "한점미소발달센터 부천점", 
      ...
      location: "경기도 부천시",
      phone: "032-9876-5432",
      services: ["언어지원", "인지지원", "작업지원", "사회성훈련"],
      specialties: ["언어발달지연", "자폐스펙트럼", "ADHD"],
      rating: 4.6,
      description: "아동발달 전문센터로 개별맞춤형 지원 프로그램을 제공합니다.",
      hours: "평일 09:00-18:00, 토요일 09:00-15:00"
    },
    { 
      name: "우아함발달센터 안산점", 
      ...
      location: "경기도 안산시",
      phone: "031-345-6789",
      services: ["언어지원", "작업지원", "인지지원", "사회성훈련", "학습지원"],
      specialties: ["언어발달지연", "ADHD", "자폐스펙트럼", "학습장애"],
      rating: 4.6,
      description: "체계적이고 전문적인 발달 지원 서비스를 제공하는 전문센터입니다.",
    ...
    { 
      ...
      location: "경기도 화성시",
      phone: "031-234-5678",
      services: ["언어지원", "작업지원", "인지지원", "사회성훈련", "감각통합교육"],
      specialties: ["자폐스펙트럼", "ADHD", "발달지연", "학습장애"],
      rating: 4.7,
      description: "아동 발달 전문센터로 개별 맞춤형 지원 프로그램을 제공합니다.",
      hours: "평일 09:00-18:00, 토요일 09:00-15:00"
    },
    { 
      name: "메이플 ABA 목동센터", 
      ...
      location: "서울시 양천구",
      phone: "02-2643-5678",
      services: ["ABA교육", "행동중재", "사회성훈련", "부모교육", "개별교육"],
      specialties: ["자폐스펙트럼", "행동문제", "사회성발달", "의사소통장애"],
      rating: 4.8,
      description: "ABA(응용행동분석) 전문센터로 자폐스펙트럼 아동의 행동지원을 제공합니다.",
      hours: "평일 09:00-18:00, 토요일 09:00-16:00"
    },
    { 
      name: "엘림아동발달센터", 
      ...
      location: "경기도 고양시",
      phone: "031-905-7890",
      services: ["언어지원", "놀이교육", "미술교육", "사회성훈련", "부모상담"],
      specialties: ["언어발달지연", "사회성발달", "정서행동문제", "학습장애"],
      rating: 4.7,
      description: "아동발달 전문센터로 언어지원, 놀이교육, 미술교육을 통합적으로 제공합니다.",
      hours: "평일 09:00-18:00, 토요일 09:00-15:00"
    },
    { 
      name: "해웃음 심리발달센터", 
      ...
      location: "서울시 마포구",
      phone: "02-334-5678",
      services: ["심리상담", "언어지원", "놀이교육", "가족상담", "부모교육"],
      specialties: ["정서행동문제", "사회성발달", "불안경향", "우울감"],
      rating: 4.6,
      description: "심리상담과 발달지원을 전문으로 하는 통합센터입니다.",
    ...
    { 
      ...
      location: "경기도 성남시",
      phone: "031-708-9012",
      services: ["언어지원", "인지지원", "작업지원", "사회성훈련", "학습지원"],
      specialties: ["자폐스펙트럼", "ADHD", "학습장애", "발달지연"],
      rating: 4.8,
      description: "개별맞춤형 발달지원과 교육 프로그램을 제공하는 전문센터입니다.",
      hours: "평일 09:00-18:00, 토요일 09:00-16:00"
    },
    { 
      name: "정관언어발달센터", 
      ...
      location: "부산시 기장군",
      phone: "051-727-3456",
      services: ["언어지원", "조음지도", "유창성지도", "음성지도", "삼킴지도"],
      specialties: ["조음장애", "유창성장애", "음성장애", "언어발달지연"],
      rating: 4.7,
      description: "언어발달 전문센터로 조음장애, 유창성장애 지원을 전문으로 합니다.",
      hours: "평일 09:00-18:00, 토요일 09:00-15:00"
    },
    { 
      name: "해오름 아동발달센터", 
      ...
      location: "경기도 수원시",
      phone: "031-205-6789",
      services: ["언어지원", "인지지원", "작업지원", "물리치료", "사회성훈련", "감각통합교육"],
    ...
    { 
      ...
      location: "부산시 해운대구",
      phone: "051-746-8901",
      services: ["언어지원", "감각통합교육", "인지지원", "사회성훈련", "미술교육"],
      specialties: ["감각통합장애", "ADHD", "학습장애", "자폐스펙트럼"],
      rating: 4.6,
      description: "감각통합교육을 중심으로 한 전문적인 발달지원 서비스를 제공합니다.",
      hours: "평일 09:00-18:00, 토요일 09:00-15:00"
    },
    { 
      name: "별하 아동발달센터", 
      ...
      location: "대구시 달서구",
      phone: "053-623-4567",
      services: ["언어지원", "놀이교육", "음악교육", "사회성훈련", "부모상담"],
      specialties: ["자폐스펙트럼", "언어발달지연", "사회성발달", "정서행동문제"],
      rating: 4.7,
      description: "창의적이고 개별화된 지원 프로그램으로 아동의 잠재력을 개발합니다.",
      hours: "평일 09:00-18:00, 토요일 09:00-15:00"
    },
    { 
      name: "정아동심리상담소", 
      ...
      location: "인천시 부평구",
      phone: "032-518-9012",
      services: ["심리상담", "놀이교육", "언어지원", "가족상담", "부모교육"],
      specialties: ["정서행동문제", "트라우마", "우울감", "불안경향"],
      rating: 4.8,
      description: "아동 심리 전문 상담소로 정서적 어려움을 전문적으로 지원합니다.",
    ...
    { 
      ...
      location: "경기도 의정부시",
      phone: "031-874-5678",
      services: ["언어지원", "조음지도", "청능훈련", "음성지도", "유창성지도"],
      specialties: ["조음장애", "청각장애", "언어발달지연", "음성장애"],
      rating: 4.6,
      description: "청각언어장애 전문 지원센터로 청능훈련과 언어지원을 제공합니다.",
      hours: "평일 09:00-18:00, 토요일 09:00-14:00"
    },
    { 
      name: "나아가다 발달센터", 
      ...
      rating: 4.7,
      description: "강원지역 대표 발달센터로 포괄적인 발달지원 서비스를 제공합니다.",
      hours: "평일 09:00-18:00, 토요일 09:00-15:00"
    },
    { 
      name: "우리 ABA 센터", 
      ...
      location: "울산시 남구",
      phone: "052-267-3456",
      services: ["ABA교육", "사회성훈련", "언어지원", "행동중재", "부모교육"],
      specialties: ["자폐스펙트럼", "행동문제", "의사소통장애", "사회성발달"],
      rating: 4.7,
      description: "ABA 교육 전문센터로 과학적 근거에 기반한 개입을 제공합니다.",
      hours: "평일 09:00-18:00, 토요일 09:00-16:00"
    },
    { 
      name: "한걸음 발달센터", 
      ...
      location: "충청남도 천안시",
      phone: "041-553-8901",
      services: ["언어지원", "인지지원", "감각통합교육", "작업지원", "물리치료"],
      specialties: ["감각통합장애", "ADHD", "발달지연", "뇌성마비"],
      rating: 4.6,
      description: "감각통합교육을 특화로 한 종합 발달지원센터입니다.",
      hours: "평일 09:00-18:00, 토요일 09:00-15:00"
    },
    { 
      name: "참소리 언어센터", 
      ...
      location: "전라북도 전주시",
      phone: "063-246-7890",
      services: ["언어지원", "조음지도", "음성지도", "유창성지도", "청능훈련"],
      specialties: ["조음장애", "음성장애", "언어발달지연", "유창성장애"],
      rating: 4.7,
      description: "언어지원 전문센터로 조음 및 음성장애 지원을 전문으로 합니다.",
      hours: "평일 09:00-18:00, 토요일 09:00-15:00"
    },
    { 
      name: "산본 발달지원센터",
      ...
      location: "경기도 군포시",
      phone: "031-394-5678",
      services: ["언어지원", "작업지원", "물리치료", "인지지원", "감각통합교육"],
      specialties: ["뇌성마비", "발달지연", "운동장애", "자폐스펙트럼"],
      rating: 4.6,
      description: "물리치료를 포함한 종합적인 발달지원 서비스를 제공합니다.",
      hours: "평일 09:00-18:00, 토요일 09:00-16:00"
    },
    { 
      name: "도란도란 심리센터", 
      ...
      location: "광주시 서구",
      phone: "062-372-9012",
      services: ["심리상담", "놀이교육", "미술교육", "가족상담", "사회성훈련"],
      specialties: ["정서행동문제", "트라우마", "사회성발달", "불안경향"],
      rating: 4.8,
      description: "아동 심리 전문센터로 따뜻하고 안전한 지원 환경을 제공합니다.",
      hours: "평일 10:00-19:00, 토요일 10:00-17:00"
    },
    { 
      name: "다다 아동발달센터", 
      ...
      phone: "064-754-3456",
      services: ["언어지원", "인지지원", "사회성훈련", "놀이교육", "부모상담"],
    ...
    { 
      ...
      location: "경상남도 창원시",
      phone: "055-284-7890",
      services: ["발달검진", "행동지원", "언어지원", "인지지원"],
      specialties: ["ADHD", "자폐스펙트럼", "발달지연", "학습장애"],
      rating: 4.7,
      description: "의학적 접근과 행동지원을 결합한 전문적인 발달의학 서비스를 제공합니다.",
    ...
    { 
      ...
      location: "대전시 유성구",
      phone: "042-863-5678",
      services: ["언어지원", "작업지원", "인지지원", "감각통합교육", "물리치료"],
      specialties: ["감각통합장애", "발달지연", "뇌성마비", "자폐스펙트럼"],
      rating: 4.6,
      description: "대전지역 대표 발달센터로 다학제적 접근을 통한 통합지원을 제공합니다.",
      hours: "평일 09:00-18:00, 토요일 09:00-15:00"
    },
    { 
      name: "아이사랑발달센터", 
      ...
      location: "경상북도 포항시",
      phone: "054-278-9012",
      services: ["언어지원", "놀이교육", "인지지원", "사회성훈련", "미술교육"],
      specialties: ["언어발달지연", "자폐스펙트럼", "정서행동문제", "ADHD"],
      rating: 4.7,
      description: "경북 동해안 지역의 아동발달 전문센터로 사랑과 전문성으로 지원합니다.",
      hours: "평일 09:00-18:00, 토요일 09:00-14:00"
    },
    { 
      name: "희망발달센터", 
      ...
      location: "전라남도 목포시",
      phone: "061-804-3456",
      services: ["언어지원", "작업지원", "인지지원", "감각통합교육", "부모상담"],
      specialties: ["발달지연", "자폐스펙트럼", "감각통합장애", "학습장애"],
      rating: 4.6,
      description: "전남 서남권 지역의 발달지원 거점센터로 희망찬 미래를 만들어갑니다.",
      hours: "평일 09:00-18:00, 토요일 09:00-15:00"
    },
    { 
      name: "푸른하늘발달센터", 
      ...
      location: "충청북도 청주시",
      phone: "043-234-7890",
      services: ["언어지원", "인지지원", "사회성훈련", "학습지원", "놀이교육"],
    ...
    { 
      ...
      location: "경기도 용인시",
      phone: "031-324-5678",
      services: ["언어지원", "작업지원", "인지지원", "감각통합교육", "음악교육"],
      specialties: ["조기개입", "발달지연", "자폐스펙트럼", "감각통합장애"],
      rating: 4.6,
      description: "용인지역의 발달지원 전문센터로 새싹같은 아이들의 성장을 돕습니다.",
      hours: "평일 09:00-18:00, 토요일 09:00-15:00"
    },
    { 
      name: "햇살발달센터", 
      ...
      location: "인천시 남동구",
      phone: "032-462-9012",
      services: ["언어지원", "인지지원", "사회성훈련", "놀이교육", "부모교육"],
    ...
    { 
      ...
      location: "경기도 안양시",
      phone: "031-222-3333",
      services: ["언어지원", "인지지원", "작업지원", "사회성훈련", "학습지원", "부모상담"],
      specialties: ["자폐스펙트럼", "ADHD", "언어발달지연", "학습장애"],
      rating: 4.8,
      description: "언어·인지·작업·사회성 등 통합 발달지원을 제공하는 전문센터.",
      hours: "평일 09:00-18:00, 토요일 09:00-16:00"
    },
    { 
      name: "틔움사회서비스센터", 
      ...
      location: "경기도 안양시",
      phone: "031-444-5555",
      services: ["언어지원", "인지지원", "사회성훈련", "가족상담", "지역사회적응훈련"],
