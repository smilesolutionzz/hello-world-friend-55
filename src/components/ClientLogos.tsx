...
const ClientLogos = () => {
  ...
  const partners = [
    { 
      ...
      location: "서울시 강남구",
      phone: "02-1234-5678",
      services: ["운동치료", "감각통합치료", "체육활동", "발달평가", "신체발달"],
      specialties: ["운동발달", "감각통합", "신체발달", "체육치료"],
      rating: 4.9,
      description: "운동 및 신체 발달 전문 센터. 운동치료, 감각통합치료, 체육활동을 통한 아동 발달 지원을 제공합니다.",
    ...
    { 
      ...
      location: "서울시 강남구",
      phone: "02-0000-0000",
      services: ["발달검진", "언어치료", "인지치료", "작업치료", "행동치료", "약물치료", "가족상담", "조기개입"],
      specialties: ["조기개입", "자폐스펙트럼", "언어발달지연", "ADHD"],
      rating: 5.0,
      description: "최고 수준의 의료진과 최신 시설을 갖춘 메인 제휴기관으로 포괄적인 발달장애 치료 서비스를 제공합니다.",
      hours: "평일 09:00-18:00, 토요일 09:00-14:00"
    },
    { 
      ...
      location: "대구광역시 중구",
      phone: "053-1234-5678",
      services: ["심리상담", "발달평가", "언어치료", "인지치료", "사회성발달", "부모상담"],
      specialties: ["심리평가", "발달장애", "언어발달", "사회성"],
      rating: 4.9,
