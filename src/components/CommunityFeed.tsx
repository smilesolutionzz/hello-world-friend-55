...
const mockPosts: CommunityPost[] = [
  // AIHPRO 매커니즘 설명 - 성공 사례
  {
    ...
    title: '6개월 동안 AIHPRO 써본 진짜 후기 (우울감 → 밝아짐)',
    content: `안녕하세요! 저 6개월 전까지만 해도 정말 힘들었거든요. 그런데 AIHPRO 덕분에 완전히 달라졌어서 혹시나 저랑 비슷한 분들 계실까 봐 제 경험 써봐요.

처음엔 뭔가 이상한 사이트인 줄 알았는데 ㅋㅋ 일단 고민을 익명으로 써봤어요. 누구한테도 말 못 했던 얘기들... 그랬더니 AI가 바로 분석해주더라고요. 진짜 신기했어요. 제 성향이랑 상황을 정확히 파악하고 전문가까지 추천해주고.

AI가 전문가 3명 추천해줬는데, 각자 전문분야랑 경력, 어떤 스타일로 상담하는지 다 알려주더라고요. 저는 그 중에서 가장 마음에 드는 분을 골랐어요.

그다음부터 온라인으로 상담받기 시작했는데요, 주 2회씩 각각 50분 정도? 집에서 편하게 받을 수 있어서 좋았어요. 선생님이 제 상황에 맞춰서 치료 계획도 세워주시고...

중간중간 AI가 제 상담 진도도 체크해주고, 상담 방향도 조정해주더라고요. 나중에는 가족 상담도 권해주셔서 같이 받았어요.

결과적으로는... 3개월 만에 우울감이 거의 사라졌고, 6개월 지난 지금은 완전히 예전으로 돌아왔어요! 진짜 인생이 바뀌었다고 해도 과언이 아니에요.

저처럼 혼자 끙끙 앓지 마시고 도움받으세요. 생각보다 훨씬 체계적이고 전문적이에요!`,
  ...
  // 구체적인 매칭 과정 사례
  {
    ...
    content: `혹시 AIHPRO 어떻게 이용하는지 궁금하신 분들 있으시면 제 경험 공유드려요!

처음엔 저도 반신반의했는데, 정말 체계적으로 도와주시더라고요.

일단 고민을 익명으로 써서 올렸어요. "요즘 육아랑 직장 때문에 너무 힘들다, 아침에 일어나기도 싫다" 이런 식으로... 솔직하게 다 적었더니 3분 정도 걸렸나?

그랬더니 AI가 바로 분석해주는데, 30초도 안 걸렸어요. 우울 경향이 있고 번아웃 같다면서 워킹맘 전문 상담을 권하더라고요. 그리고 전문가 3명을 추천해줬는데,

그 중에서 "이수석 발달센터장"님을 선택했어요. 워킹맘 상담 경력이 8년이고 평점도 4.9점이라서요.

온라인으로 상담받았는데 주 2회 (화요일 저녁 8시, 토요일 오전 10시) 각각 50분씩이었어요. 첫 상담에서는 제 상황을 자세히 들어봐 주시고...
...
중간중간 AI가 제 진도도 체크해주고, 상담 방향도 조정해주더라고요. 나중엔 가족 상담도 권해주시고...

결과적으로 8주 만에 우울감이 많이 나아졌어요! 완전히 다른 사람이 된 것 같아요ㅠㅠ 비용도 병원 가는 것보다 반값이고, 집에서 편하게 받을 수 있어서 너무 좋았어요!`,
    tags: ['실제후기', '매칭과정', '워킹맘', '우울감관리'],
    timestamp: '고정 게시물',
    likes: 234,
    hasLiked: false,
    comments: [
  ...
  // 전문가에게 하는 질문
  {
    ...
    content: '3년째 같은 회사에서 일하고 있는데 최근 몇 달간 무기력감이 심해졌습니다. 아침에 일어나기도 힘들고, 업무에 집중도 안 되고... 이게 번아웃인지 우울감인지 구분이 안 가네요. 어떤 도움을 받아야 할까요?',
    ...
    comments: [
      {
        ...
        content: '번아웃과 우울감은 증상이 비슷할 수 있습니다. 정확한 평가를 위해 전문가 상담을 받아보시기 바랍니다. 무엇보다 충분한 휴식이 필요해요.',
        timestamp: '5시간 전',
        likes: 24,
        isExpertAnswer: true
      },
  ...
  // 기존 아동 ADHD 질문
  {
    ...
    content: '최근 ADHD 평가를 받은 7세 아들이 있습니다. 전문가 지원과 함께 집에서 할 수 있는 집중력 향상 방법이 있을까요? 특히 숙제할 때 계속 산만해져서 어떻게 도와줘야 할지 모르겠습니다.',
    tags: ['ADHD', '7세', '집중력', '질문'],
    timestamp: '4시간 전',
    likes: 12,
    hasLiked: true,
  ...
  },
  {
    ...
    title: '14세 우울감 관리 성공 사례',
    content: '중학교 2학년 아들이 학교 적응에 어려움을 겪으며 우울감을 보였습니다. AIHPRO를 통해 만난 전문 상담사와 6개월간 상담받으며 서서히 회복되었고, 이제는 밝은 모습을 되찾았어요. 전문가의 도움이 정말 중요하다는 걸 느꼈습니다.',
    tags: ['우울감', '14세', '청소년상담', '성공사례'],
    timestamp: '2일 전',
    likes: 18,
    hasLiked: false,
    comments: [
  ...
  // 중년 우울증 질문
  {
    ...
    title: '40대 중년 우울감, 상담받는 게 도움이 될까요?',
    content: '회사에서 구조조정으로 스트레스받고, 집에서도 아이들 교육비 걱정에 잠을 못 자고 있습니다. 무기력감이 심해지고 있는데, 상담이 실질적으로 도움이 될까요? 비용도 부담되고 시간도 내기 어려워서 고민입니다.',
    tags: ['중년우울', '직장스트레스', '상담', '성인상담'],
    timestamp: '1주일 전',
    likes: 38,
    hasLiked: false,
    comments: [
  ...
  },
  {
    id: 'pin-infant',
    type: 'success',
    author: { name: '세살맘', isAnonymous: false, isExpert: false, isInstitution: false, avatar: '/api/placeholder/40/40' },
    title: '영유아 수면퇴행, 이렇게 넘겼어요',
    content: '24개월 아기가 새벽마다 깨서 너무 지쳤었어요. 여기서 감정체크와 전문가 매칭 받아 “수면 루틴 재설계” 미션을 실천했습니다. 2주 만에 밤수 줄고 새벽 깨움이 사라졌어요. 기록 남기니 스스로도 달라지는 게 보여서 동기부여가 됐어요!',
    tags: ['영유아','수면','육아스트레스'],
    timestamp: '고정 게시물',
    likes: 89,
    hasLiked: false,
  ...
  },
  {
    id: 'pin-adhd-child',
    type: 'success',
    author: { name: '초등아빠', isAnonymous: false, isExpert: false, isInstitution: false, avatar: '/api/placeholder/40/40' },
    title: '초등 ADHD 의심, 집중 루틴 만들기 성공',
    content: '숙제 집중이 10분도 안 되던 아이가 “10-3-10 집중 타이머” 미션과 보상표를 적용하면서 4주 만에 스스로 책상에 앉는 시간이 늘었어요. 전문가 피드백과 주간 인사이트가 큰 도움이 됐습니다.',
    tags: ['아동','ADHD','집중훈련'],
    timestamp: '고정 게시물',
    likes: 73,
    hasLiked: false,
  ...
  },
  {
    id: 'pin-elderly',
    type: 'success',
    author: { name: '장년딸', isAnonymous: false, isExpert: false, isInstitution: false, avatar: '/api/placeholder/40/40' },
    title: '치매 초기 부모님과의 소통, 이렇게 바뀌었습니다',
    content: '아버지 기억 문제가 시작되면서 갈등이 잦았는데, 여기서 제 감정 관리부터 코칭받고 “하루 1회 공감 대화 스크립트” 미션을 실천했어요. 분위기가 훨씬 부드러워지고 돌봄 스트레스도 많이 줄었습니다.',
    tags: ['노인돌봄','치매초기','가족소통'],
    timestamp: '고정 게시물',
    likes: 64,
    hasLiked: false,
