...
const mockPosts: CommunityPost[] = [
  // AIHPRO 매커니즘 설명 - 성공 사례
  {
    ...
    title: '6개월 동안 AIHPRO 써본 진짜 후기 (우울증 → 완전 회복)',
...
결과적으로 8주 만에 우울감이 많이 나아졌어요! 완전히 다른 사람이 된 것 같아요ㅠㅠ 비용도 병원 가는 것보다 반값이고, 집에서 편하게 받을 수 있어서 너무 좋았어요!`,
  ...
  },
  {
    ...
    content: '중학교 2학년 아들이 학교 적응에 어려움을 겪으며 우울증 증상을 보였습니다. AIHPRO를 통해 만난 전문 상담사와 6개월간 상담받으며 서서히 회복되었고, 이제는 밝은 모습을 되찾았어요. 전문가의 도움이 정말 중요하다는 걸 느꼈습니다.',
