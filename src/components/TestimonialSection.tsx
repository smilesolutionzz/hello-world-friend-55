      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-amber-500/10 border border-amber-500/20 rounded-full mb-4">
            ...
            <span className="text-sm font-semibold text-amber-300">실제 후기</span>
          </div>
        ...
        >
          <motion.div
            ...
            exit={{ opacity: 0, x: -20 }}
            className="bg-slate-800/50 backdrop-blur-sm border border-white/5 rounded-2xl p-6 md:p-8"
          >
            {/* Quote Icon */}
              ...
              {testimonials.map((_, i) => (
                <button
                  ...
                  className={`w-2 h-2 rounded-full transition-all ${
                    i === currentIndex ? 'bg-purple-400 w-6' : 'bg-white/20'
                  }`}
                />
              ))}
            </div>
