...
import { Clock, Heart, Star, CheckCircle, Home } from 'lucide-react';
import { TOKEN_COSTS } from '@/constants/tokenCosts';

export const DepressionPackage = () => {
  const navigate = useNavigate();

  const depressionTests = [
    {
      id: 1,
      title: '우울증 선별검사',
      duration: '10분',
    ...
    },
    {
      ...
      description: '우울 정도 단계별 분석',
      path: '/premium-assessment?type=mood'
    },
    {
      id: 3,
      title: '전문가 30분 상담',
        ...
        <div className="text-center mb-12">
          <div className="flex items-center justify-center gap-3 mb-4">
            ...
            <h1 className="text-3xl font-bold text-foreground">
              우울감 관리 <span className="text-primary">맞춤 패키지</span>
            </h1>
          </div>
          <p className="text-muted-foreground text-lg">
            기분저하, 무기력, 의욕상실에 최적화된 솔루션
          </p>
        </div>
