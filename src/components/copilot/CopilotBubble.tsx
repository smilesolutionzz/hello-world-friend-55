      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="fixed bottom-[72px] left-4 right-4 z-[60] md:left-6 md:right-auto md:w-[380px] md:bottom-6"
          >
            <div className="rounded-2xl border border-white/10 bg-slate-900/95 backdrop-blur-xl shadow-2xl overflow-hidden flex flex-col max-h-[70vh]">
              {/* Header */}
