...
const faqData: FAQItem[] = [
  ...
  },
  {
    ...
    answer: "AIHPRO의 검사는 전문가 자문을 거친 자체 개발 문항을 사용해요! 📊\n\n✅ 검사 특징:\n• ADHD: 전문가 감수 기반 주의력 평가\n• 우울증: 전문 심리학 기반 기분 상태 체크\n• 불안: AI 기반 불안 수준 측정\n\n✅ AI 분석 특징:\n• 수천 건의 데이터로 학습된 AI\n• 패턴 인식으로 개인화된 분석\n• 전문가 자문을 거친 해석 제공\n\n⚠️ 단, 자가체크 도구로 의학적 판단을 대체하지 않아요. 정확한 평가는 전문가 상담을 권장드려요!"
  },
  {
  ...
  {
    question: "유료 플랜은 어떤 혜택이 있나요?",
    answer: "AIHPRO는 단일 상품으로 운영돼요! ⭐\n\n📌 무료 플랜:\n• 우울·스트레스·ADHD 체험검사 무제한\n• 회원가입 없이도 이용 가능\n\n📌 7일 마음 트랙 (₩7,900 일시불, 정가 ₩49,000 / 60% 할인):\n• 모든 심층 검사 무제한\n• AI 심층 분석 리포트 무제한\n• 30일 맞춤 마음 변화 로드맵\n• 전문가 코칭 가이드 동봉\n• 종료 시 변화 종합 리포트(PDF)\n\n📌 안심 보장:\n• 자동 결제 없음 (1회 일시불)\n• 마음에 들지 않으면 7일 내 100% 환불\n• 신규 가입 시 심층 검사 이용권 2개 즉시 지급"
  }
];
