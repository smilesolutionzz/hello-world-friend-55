...
const PERSONAS: Persona[] = [
  {
    ...
    messages: [
      ...
      { sender: 'expert', text: '7일 마음 트랙(₩7,900)에 발달 놀이 워크북 + 주간 발달 체크 + 전문가 코칭이 포함돼요.', time: '10:16' },
    ...
    messagesEn: [
      ...
      { sender: 'expert', text: '7-Day Mind Track (₩7,900) includes play workbook + weekly dev check + expert coaching.', time: '10:16' },
    ...
    highlights: [
      ...
      { emoji: '🎈', before: '“집에서 뭘 해줘야 할지 몰라요.”', after: '발달 놀이 워크북 + 주간 체크 — ₩7,900', reaction: '“진짜 빨리 시작해야겠어요.”' },
    ],
    highlightsEn: [
      ...
      { emoji: '🎈', before: '"Don\'t know what to do at home"', after: 'Play workbook + weekly check — ₩7,900', reaction: '"Starting right away."' },
    ],
    cta: { label: '발달 추적 트랙 — ₩7,900', labelEn: 'Development Track — ₩7,900', href: '/report-generator' },
  ...
  },
  {
    ...
    messages: [
      ...
      { sender: 'expert', text: '네! 7일 마음 트랙(₩7,900) 한 번이면 매일 워크북·검사·전문가 코칭까지 30일간 함께해요.', time: '12:09' },
    ...
    messagesEn: [
      ...
      { sender: 'expert', text: 'Yes — the 7-Day Mind Track (₩7,900) gives you 30 days of workbooks, tests, and expert coaching.', time: '12:09' },
    ...
    highlights: [
      ...
      { emoji: '🤩', before: '“이거 얼마예요?”', after: '7일 마음 트랙 — ₩7,900 (1회 결제)', reaction: '“상담 한 번 값으로 30일이라니!”' },
    ],
    highlightsEn: [
      ...
      { emoji: '🤩', before: '"How much?"', after: '7-Day Mind Track — ₩7,900', reaction: '"30 days for one session price!"' },
    ],
    cta: { label: '7일 마음 트랙 — ₩7,900', labelEn: '7-Day Mind Track — ₩7,900', href: '/report-generator' },
  ...
  },
  {
    ...
    messages: [
      ...
      { sender: 'expert', text: '7일 마음 트랙(₩7,900)면 주간 변화 추적 + 위험 신호 알림까지 받아보실 수 있어요.', time: '21:20' },
    ...
    messagesEn: [
      ...
      { sender: 'expert', text: '7-Day Mind Track (₩7,900) gives you weekly tracking + risk alerts.', time: '21:20' },
    ...
    highlights: [
      ...
      { emoji: '📈', before: '“매번 검사 따로 받기 부담돼요.”', after: '주간 추적 + 위험 신호 알림 — ₩7,900', reaction: '“진짜 필요했던 거예요.”' },
    ],
    highlightsEn: [
      ...
      { emoji: '📈', before: '"Repeat tests are expensive"', after: 'Weekly tracking + risk alerts — ₩7,900', reaction: '"Exactly what I needed."' },
    ],
    cta: { label: '청소년 마음 추적 트랙 — ₩7,900', labelEn: 'Teen Mind Track — ₩7,900', href: '/report-generator' },
  ...
  },
  {
    ...
    messages: [
      ...
      { sender: 'expert', text: '7일 마음 트랙(₩7,900) — 매일 측정 + 회복 가이드 + 전문가 코칭이 다 포함돼요.', time: '09:36' },
    ...
    messagesEn: [
      ...
      { sender: 'expert', text: '7-Day Mind Track (₩7,900) — daily measurement + recovery guide + expert coaching.', time: '09:36' },
    ...
    highlights: [
      ...
      { emoji: '💼', before: '“병원은 부담돼요.”', after: '매일 측정 + 코칭 — ₩7,900', reaction: '“오늘 바로 시작할게요.”' },
    ],
    highlightsEn: [
      ...
      { emoji: '💼', before: '"Hospital is too much"', after: 'Daily check + coaching — ₩7,900', reaction: '"Starting today."' },
    ],
    cta: { label: '번아웃 회복 트랙 — ₩7,900', labelEn: 'Burnout Recovery — ₩7,900', href: '/report-generator' },
  ...
  },
  {
    ...
    messages: [
      ...
      { sender: 'expert', text: '네, 7일 마음 트랙(₩7,900)로 가족이 함께 변화 추적 + 위험 알림을 받으실 수 있어요.', time: '15:07' },
    ...
    messagesEn: [
      ...
      { sender: 'expert', text: 'Yes, 7-Day Mind Track (₩7,900) lets family share tracking + risk alerts.', time: '15:07' },
    ...
    highlights: [
      ...
      { emoji: '👨‍👩‍👧', before: '“가족이 따로 챙기기 힘들어요.”', after: '가족 공유 추적 — ₩7,900', reaction: '“이걸 먼저 봤어야 했네요.”' },
    ],
    highlightsEn: [
      ...
      { emoji: '👨‍👩‍👧', before: '"Hard to track together"', after: 'Family shared tracking — ₩7,900', reaction: '"Wish I knew earlier."' },
    ],
    cta: { label: '시니어 인지 케어 트랙 — ₩7,900', labelEn: 'Senior Cognitive Track — ₩7,900', href: '/report-generator' },
