...
const OFFERINGS: Record<InterventionDay, {
  ...
  21: {
    ...
    price: 39000,
    title: "심화 단계 집중 케어",
    subtitle: "시간권으로 우선 매칭 (시간당 ₩39,000)",
    description: "마지막 9일을 가장 효과적으로 마무리할 수 있도록, 검증된 전문가 1:1 심화 상담을 시간권으로 우선 매칭해드립니다.",
    cta: "전문가 시간권으로 우선 매칭",
    icon: ShieldCheck,
    gradient: "from-rose-500 to-orange-500",
    badge: "Day 21 심화 케어",
    benefits: ["검증 전문가 우선 매칭", "60분 심화 상담 (시간권 1h 차감)", "맞춤 마무리 가이드"],
