...
const MILESTONES = [
  { day: 7, icon: MessageCircle, label: "1주차 적응 점검", price: "₩9,900", desc: "전문가 텍스트 점검", color: "from-blue-500 to-cyan-500", route: "/expert-hiring?intervention=day7&offering=text_review" },
          ...
          return (
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="text-[11px] text-slate-600 mt-0.5 break-keep">{m.desc} · <span className="font-bold text-primary">{m.price}</span></div>
              </div>
              {reached ? (
                <Button
                  size="sm"
                ...
                >
                  {m.price} 결제 <ArrowRight className="w-3 h-3 ml-1" />
                </Button>
              ) : (
