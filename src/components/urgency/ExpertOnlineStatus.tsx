    ...
    <div className="bg-gradient-to-r from-green-500/10 to-emerald-500/10 border border-green-500/30 rounded-2xl p-6 backdrop-blur-sm">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            <p className="text-white text-xs font-medium">온라인 전문가</p>
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <p className="text-white text-xs font-medium">10분 내 응답</p>
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <p className="text-white text-xs font-medium">평균 응답시간</p>
