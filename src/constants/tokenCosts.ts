...
export const SUBSCRIPTION_ORIGINAL_PRICE = MIND_TRACK_ORIGINAL_PRICE;
export const SUBSCRIPTION_DISCOUNT_PERCENT = MIND_TRACK_DISCOUNT_PERCENT;
export const SUBSCRIPTION_YEARLY_PRICE = MIND_TRACK_PRICE;
export const SUBSCRIPTION_YEARLY_ORIGINAL_PRICE = MIND_TRACK_ORIGINAL_PRICE;
export const SUBSCRIPTION_YEARLY_DISCOUNT_PERCENT = MIND_TRACK_DISCOUNT_PERCENT;
export const SUBSCRIPTION_YEARLY_MONTHLY_PRICE = MIND_TRACK_PRICE;
export const SINGLE_REPORT_PRICE = MIND_TRACK_PRICE;
export const SINGLE_TEST_PRICE = MIND_TRACK_PRICE;

// === B2B 발달치료센터 (/b2b-center) ===
export const B2B_CENTER_MONTHLY = 39000;          // ₩/월, 케어플 ₩44,000 대비
export const B2B_CENTER_COMPETITOR_PRICE = 44000; // 케어플센터 기준가
