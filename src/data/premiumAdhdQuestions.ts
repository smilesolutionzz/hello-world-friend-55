// 프리미엄 ADHD 정밀검사 문항 (CAT 방식 적용)
// 본 검사는 AIH에서 독자 개발한 창작형 ADHD 전문 평가도구입니다.

export const premiumAdhdAssessmentInfo = {
  title: "AIH 프리미엄 ADHD 정밀검사",
  subtitle: "CAT 기반 적응형 평가 시스템",
  description: "국제 표준 기반의 정밀한 ADHD 증상 평가와 AI 심층 분석을 제공합니다",
  features: [
    "DSM-5 기반 정밀 진단 문항",
    "연령별 맞춤 평가 시스템",
    "부주의/과잉행동/충동성 세분화 분석",
  ...
  disclaimer: "본 검사는 AIH에서 DSM-5 기준을 참고하여 독자 개발한 창작형 정밀 평가도구입니다."
};
