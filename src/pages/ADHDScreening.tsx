            ...
            <AnimatePresence mode="wait">
                  ...
                  <Card className="mb-6">
                    <CardContent className="py-6">
                      ...
                      <ul className="space-y-3 text-gray-600">
                        ...
                        <li className="flex items-start gap-2">
                          <CheckCircle2 className="w-5 h-5 text-teal-500 mt-0.5" />
                          <span>최근 6개월간의 행동을 기준으로 응답해주세요</span>
                        </li>
                        <li className="flex items-start gap-2">
              ...
              {phase === 'analyzing' && (
                ...
                >
                  ...
                  <h2 className="text-2xl font-bold mb-4">AI가 결과를 분석하고 있어요</h2>
                  ...
                  <Card className={`mb-6 ${
                    ...
                    <CardContent className="py-8 text-center">
                      ...
                      <h2 className="text-2xl font-bold mb-2">
                        {result.riskLevel === 'low' ? '낮은 위험도' :
                         result.riskLevel === 'moderate' ? '중간 위험도' : '높은 위험도'}
                      </h2>
                      <p className="opacity-90">총점: {result.totalScore} / {questions.length * 3}</p>
                    </CardContent>
                  </Card>
                    ...
                    <CardContent>
                      <ul className="space-y-2">
                        {result.nextSteps.map((step, i) => (
                          <li key={i} className="flex items-start gap-2">
                            <span className="w-6 h-6 rounded-full bg-teal-100 text-teal-600 flex items-center justify-center text-sm font-bold">
                              {i + 1}
                            </span>
                            <span>{step}</span>
                          </li>
