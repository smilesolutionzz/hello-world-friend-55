...
const faqs = [
  { q: "AIHPRO란 무엇인가요?", a: "AIHPRO(AI Human Pro)는 AI 기반 심리검사, 발달평가, 정신건강 상담을 제공하는 종합 케어 플랫폼입니다. 우울증 자가체크, ADHD 선별검사, 스트레스 테스트, MBTI 성격검사, 아동 발달검사 등 30종 이상의 검사와 전문가 수준의 AI 분석 리포트를 제공합니다." },
  ...
  { q: "무료 우울증 테스트를 할 수 있나요?", a: "네, AIHPRO에서 PHQ-9 기반의 우울증 자가체크를 무료로 시작할 수 있습니다. 연령별(청소년/성인/노인) 맞춤 문항으로 구성되며, 검사 후 AI가 심각도 분석과 맞춤 권고사항을 제공합니다." },
