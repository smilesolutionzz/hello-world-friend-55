...
const columns: Column[] = [
  {
    id: "1",
    title: "피할 수 없는 AI 시대, 결국 사람이 포함되어야 합니다",
    excerpt: "기술은 도구일 뿐입니다. 진정한 치유와 성장은 '사람'에게서 시작됩니다. AI와 전문가가 함께할 때 비로소 진정한 변화가 시작됩니다.",
    category: "비전",
    date: "2025년 10월",
    readTime: "5분",
    featured: true
  ...
  {
    id: "2",
    title: "데이터가 쌓이면 보이는 것들",
    excerpt: "여러분의 일상 속 작은 순간들이 모여 초개인화된 종합 리포트가 됩니다. 숫자가 아닌, 여러분만의 성장 스토리로 말입니다.",
    category: "인사이트",
    date: "2025년 10월",
    readTime: "4분"
  },
  {
    ...
    excerpt: "AI 분석과 전문가 검토의 완벽한 조화. 정확한 회복과 예방을 위한 우리의 접근법을 소개합니다.",
    category: "방법론",
    date: "2025년 10월",
    readTime: "6분"
  }
