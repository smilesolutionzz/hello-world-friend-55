...
const columns: Column[] = [
  {
    id: "february-2026-new-semester",
    title: "새 학기 앞둔 엄마, 아빠에게 - 불안해도 괜찮습니다",
    excerpt: "3월이 다가옵니다. 아이도, 부모도 설렘보다 걱정이 앞서는 계절. 새 교실, 새 친구, 새 선생님 — 변화 앞에서 흔들리는 건 당연합니다. 오늘은, 그 마음에 대해 이야기하고 싶습니다.",
    fullContent: `3월이 코앞입니다.

마트에서 새 실내화를 고르고, 이름표를 붙이고, 가방을 사주면서도 — 마음 한쪽이 무겁습니다.
...
저도 아이를 키우는 사람입니다. 그래서 압니다. 새 학기 앞에서 부모가 느끼는 그 감정이 단순한 '걱정'이 아니라는 것을.

그건 사랑입니다. 내 아이가 세상에서 상처받지 않았으면 하는, 가장 원초적인 사랑.

그런데 이 사랑이 때로는 우리를 옥죕니다. 아이의 모든 반응을 관찰하게 되고, 사소한 변화에도 "혹시?" 하는 불안이 밀려옵니다.

오늘은, 그 마음을 한 번 내려놓는 이야기를 해보려 합니다.


아이들은 우리가 생각하는 것보다 강합니다

많은 부모님들이 착각하시는 것이 있습니다. "우리 아이는 예민해서", "우리 아이는 소심해서" — 이런 말, 저도 수없이 했습니다.

그런데 서비스를 운영하면서 수만 명의 아이 데이터를 보며 깨달은 것이 있어요.

아이들은, 놀라울 정도로 적응합니다.

첫 주에 울던 아이가 한 달 뒤에는 웃으며 뛰어갑니다. 친구가 없다며 힘들어하던 아이가 어느새 단짝이 생겨 있습니다.

물론 모든 아이가 그런 건 아닙니다. 시간이 더 필요한 아이도 있고, 전문가의 도움이 필요한 아이도 있습니다.

중요한 건, "우리 아이만 뒤처지는 건 아닐까"라는 비교의 함정에 빠지지 않는 것입니다.
...
새 학기 첫 2주 동안 아이가 힘들어하면, 부모는 패닉에 빠집니다. "잘못된 건 아닌지", "전학을 보내야 하는 건 아닌지."

잠깐요. 숨 한번 쉬세요.

적응에는 최소 한 달이 걸립니다. 어른도 새 직장에서 한 달은 어색하잖아요. 아이에게 그 시간을 주세요.

둘. 아이의 말보다 행동을 보세요

"학교 싫어", "친구 없어" — 이런 말에 부모 마음이 무너집니다.

하지만 아이들은 감정을 말로 정확히 표현하기 어렵습니다. "싫어"가 "아직 낯설어"일 수 있고, "친구 없어"가 "아직 이름을 못 외웠어"일 수 있습니다.

아이의 말보다는, 밥은 잘 먹는지, 잠은 잘 자는지, 주말에 놀고 싶은 친구 이름이 나오는지 — 행동의 변화를 관찰해주세요.

셋. 선생님과 대화하세요, 하지만 "적당히"

담임선생님과의 소통은 중요합니다. 하지만 매일 카톡을 보내거나, 사소한 것마다 확인하면 역효과가 납니다.

한 달에 한두 번, "우리 아이 어때요?"라고 편하게 물어보는 것. 그것만으로도 충분합니다.

넷. 아이 앞에서 불안해하지 마세요

이것이 가장 중요합니다.

아이들은 부모의 감정을 스펀지처럼 흡수합니다. 엄마가 불안하면 아이도 불안해집니다. 아빠가 걱정하면 아이도 "나한테 문제가 있나?"라고 생각합니다.

아이 앞에서는 담담하게. "너는 잘할 수 있어. 새로운 친구를 만나는 건 시간이 좀 걸리는 거야. 엄마(아빠)도 그랬어."

이 한마디가, 수백만 원짜리 상담보다 효과적입니다.
...
"괜찮아, 다 잘될 거야"라는 말만으로 해결되지 않는 상황도 있습니다.

아이가 한 달이 넘도록 등원을 거부한다면.
밤마다 악몽을 꾸거나 야뇨가 시작됐다면.
갑자기 말수가 줄고 표정이 어두워졌다면.
자해 행동이나 극단적인 감정 표현을 보인다면.

이럴 때는 "시간이 해결해주겠지"가 아니라, 전문가의 눈이 필요합니다.

저희 AIHumanPro를 만든 이유가 바로 이것입니다. 병원에 가기 전, 혹은 병원에서 1년을 기다리는 동안, 부모님이 객관적으로 아이의 상태를 파악할 수 있는 도구.

무료 발달 검사, AI 관찰 분석, 전문가 리포트 — 이 모든 것이 "그때 확인해볼 걸"이라는 후회를 줄이기 위해 존재합니다.
...
새 학부모 단톡방, 새 담임선생님, 새로운 학원 시간표 — 부모에게도 적응이 필요한 시간입니다.

그러니 자신에게도 너그러워지세요. 완벽한 부모는 없습니다. "내가 뭘 잘못했을까"라고 자책하는 순간이 온다면, 이 글을 다시 한번 읽어주세요.

당신은 이미 충분히 잘하고 있습니다.

이 글을 클릭한 것만으로도, 당신이 얼마나 아이를 사랑하는지 증명됩니다.
...
AIHumanPro 대표 이수석 드림

---

P.S. 새 학기 전, 아이의 현재 발달 상태를 한번 체크해보고 싶으시다면 — 저희 무료 검사를 이용해보세요. 3분이면 됩니다. 그 3분이 한 학기를 바꿀 수도 있습니다.`,
    category: "대표 칼럼",
    date: "2026년 2월",
    readTime: "7분",
    featured: true
  ...
  {
    id: "january-2026-10k",
    title: "1만 명의 기적, 그리고 약속 - 2026년을 열며",
    excerpt: "2025년 11월 서비스를 시작한 지 두 달, 우리에게 1만 명의 소중한 분들이 찾아오셨습니다. 그 한 분 한 분의 이야기가 저희를 울렸고, 웃게 했고, 더 나아가게 했습니다. 그래서 결심했습니다. 무료로 계속 가겠다고.",
    fullContent: `1만 명.

이 숫자가 제 앞에 놓였을 때, 저는 한동안 화면을 바라보기만 했습니다.

2025년 11월, 작은 희망 하나를 품고 서비스를 시작했습니다. "아이의 발달이 걱정되는 부모님들에게 조금이라도 도움이 되자." 그게 전부였습니다.

그런데 두 달 만에 1만 명이 찾아와 주셨습니다.


여러분이 보내주신 메시지들

매일 아침, 저는 여러분이 보내주신 피드백을 읽습니다. 솔직히 말씀드리면, 많이 울었습니다.

"처음으로 아이의 문제가 '문제'가 아니라 '특성'이라는 걸 알게 됐어요. 감사합니다."
— 5살 아들을 키우는 어머니

"병원에서는 1년을 기다려야 했는데, 여기서 먼저 방향을 잡을 수 있었어요. 덕분에 불안한 시간이 줄었습니다."
— 발달지연 진단을 받은 아이의 아버지

"무료라서 의심했어요. 근데 진짜였어요. 이렇게 자세하게 분석해주시다니."
— 쌍둥이를 키우는 워킹맘

"혼자 끙끙 앓다가 처음으로 전문가와 상담했어요. 왜 진작 몰랐을까요."
— 사춘기 자녀와 갈등 중인 어머니

이런 메시지 하나하나가 저희 팀에게는 동력이 됩니다.
...
저에게도 아이가 있습니다. 처음 발달 문제를 의심했을 때, 정보는 없고 불안만 가득했습니다. 병원 예약은 6개월 대기, 사설 검사는 100만 원 이상. "이게 맞나?"라는 확신 없이 돈을 쓰는 것도, 그냥 기다리는 것도 괴로웠습니다.

그때 제가 가장 필요했던 것:
1. 지금 우리 아이 상태가 어떤지 객관적으로 아는 것
2. 전문가에게 "이건 정상이에요" 혹은 "이건 봐야 해요"라고 듣는 것
3. 그 과정이 너무 비싸지 않았으면 하는 것

그래서 만들었습니다. 그리고 그래서 무료입니다.


경제적 장벽이 아이의 미래를 결정해선 안 됩니다

발달 문제의 골든타임은 빠르면 빠를수록 좋습니다. 하지만 현실은 어떻습니까?

• 발달검사 평균 비용: 50만 원 ~ 150만 원
• 병원 대기 기간: 평균 3~6개월
• 사설 상담 비용: 회당 15만 원 ~ 30만 원

형편이 안 되는 가정의 아이들은 골든타임을 놓칩니다. 이건 공정하지 않습니다.

우리는 이 장벽을 허물고 싶습니다.


지속 가능한 무료를 위한 우리의 약속

"무료면 지속 가능해요?"

좋은 질문입니다. 저희도 고민했습니다. 그래서 세운 원칙이 있습니다.


첫째, 기본 서비스는 영원히 무료입니다.
...
둘째, 프리미엄 서비스로 수익을 창출합니다.

• 전문가 심층 상담 (유료, 단 기존 대비 70% 저렴)
• 기관용 B2B 서비스
• 연구 목적의 익명 데이터 분석

기본기는 무료로 지키고, 선택적 프리미엄으로 운영합니다.


셋째, 함께 성장하는 구조입니다.

여러분이 늘어날수록, 우리의 AI는 더 정확해집니다. 더 정확해질수록, 더 많은 분들이 도움받을 수 있습니다.

여러분은 사용자인 동시에 이 생태계의 공동 창조자입니다.
...
1만 명에서 시작해서, 올해는 10만 명의 가정에 희망을 전하고 싶습니다.


우리가 준비하고 있는 것들

1. 더 정확한 AI 분석: 15만 건의 데이터 학습 완료, 정확도 94%
2. 전문가 네트워크 확대: 현재 50명 → 목표 200명
3. 지역 연계 서비스: 가까운 발달센터, 병원 연결
4. 부모 커뮤니티: 비슷한 고민을 가진 분들과의 연결
...
무엇이 더 필요하신지, 어떤 점이 불편하신지, 어떤 기능이 있으면 좋겠는지. 여러분의 목소리가 우리의 방향을 결정합니다.


1만 명의 부모님께 드리는 감사 인사

새벽 2시에 아이 걱정에 잠 못 이루며 검색하다 저희를 찾으신 분,
"혹시나" 하는 마음에 검사해보신 분,
친구에게 추천받아 오신 분,
의심 반, 희망 반으로 클릭하신 분,
...
여러분이 계시기에 저희가 있습니다.
여러분의 아이들이 건강하게 자라는 것,
그것이 저희가 존재하는 이유입니다.

2026년도 함께해 주세요.
우리는 절대 멈추지 않겠습니다.
우리는 절대 여러분을 돈 때문에 포기하게 하지 않겠습니다.
...
P.S. 이 글을 읽고 계신 분 중, 아직 서비스를 사용해보지 않으신 분이 계시다면 — 지금 바로 시작해보세요. 무료입니다. 진짜로요.`,
    category: "대표 칼럼",
    date: "2026년 1월",
    readTime: "8분",
    featured: true
...
정신과는 '이상한 사람'이 가는 곳이 아닙니다. 삶을 더 잘 살고 싶은 사람, 자신을 더 깊이 이해하고 싶은 사람, 변화하고 싶은 사람이 가는 곳입니다.
...
정신과 약은 뇌의 화학적 불균형을 바로잡는 것입니다. 당뇨 환자가 인슐린을 맞는 것과 같습니다. 고혈압 환자가 혈압약을 먹는 것과 같습니다.

의지의 문제가 아닙니다. 질병의 치료입니다.


상담을 받는다는 것

상담실에 앉아 자신의 이야기를 꺼내는 것, 그것은 자기 자신에게 가장 솔직해지는 순간입니다.
...
10년 전만 해도 정신과는 숨겨야 하는 곳이었습니다. 지금은 많은 유명인들이 자신의 정신건강 이야기를 공개합니다. 정신건강을 돌보는 것이 자기관리의 영역으로 인식되기 시작했습니다.

당신이 치료받는 것을 부정적으로 보는 사람이 있다면, 그것은 그 사람의 무지입니다. 당신의 문제가 아닙니다.
...
치료는 끝이 있습니다. 지금은 어둡고 긴 터널 같아도, 반드시 빛이 보이는 날이 옵니다.
