...
노년은 **삶의 마지막이 아닌, 새로운 장**입니다.

- 더 이상 일하지 않아도 됩니다
- 책임에서 자유로워집니다
- 진정으로 원하는 것을 할 수 있습니다
...
석양이 가장 아름답듯,  
인생의 황혼도 가장 아름다울 수 있습니다.

그 아름다움을 온전히 누리실 수 있도록  
**우리가 함께하겠습니다.**

여러분의 삶은 여전히 가치 있고,  
여러분은 여전히 사랑받을 자격이 있습니다.`,
    category: "노인",
    date: "2025년 10월",
    readTime: "11분"
  }
...
const Column = () => {
  ...
  const categories = ["전체", "비전", "학부모", "리더십", "청소년", "영유아", "노인"];
