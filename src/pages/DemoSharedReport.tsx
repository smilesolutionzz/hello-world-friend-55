...
<p style="text-align:center;font-size:10px;color:#6366f1;font-weight:600;letter-spacing:3px;margin-bottom:4px;">AIHPRO.APP</p>
...
<hr style="border:none;border-top:1px solid #e2e8f0;margin:16px 0;" />
<p style="font-size:10px;color:#94a3b8;text-align:center;">⚠️ 본 소견서는 발달 코칭 및 의사결정 보조를 위한 참고용 분석이며, 의료 진단·치료를 대체하지 않습니다. 임상적 판단이 필요한 경우 자격을 갖춘 전문가와 상담하시기 바랍니다.</p>
</div>`
      },
      {
...
<div class="footer">
<p>© ${new Date().getFullYear()} AIHPRO.APP · AI 기반 심리·발달 분석 플랫폼</p>
<p style="margin-top:4px;">본 리포트는 발달 코칭 및 의사결정 보조를 위한 참고용 분석이며, 의료 진단·치료를 대체하지 않습니다.</p>
        ...
        <div className="max-w-2xl mx-auto px-4 pb-24" id="demo-report-content">
          ...
          <div className="mt-6 px-1">
            <p className="text-[10px] text-muted-foreground/60 text-center leading-relaxed">
              본 리포트는 발달 코칭 및 의사결정 보조를 위한 참고용 분석이며, 의료 진단·치료를 대체하지 않습니다.<br />
              임상적 판단이 필요한 경우 자격을 갖춘 전문가와 상담하시기 바랍니다.
            </p>
