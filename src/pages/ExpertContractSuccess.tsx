  ...
  useEffect(() => {
    const verifyPayment = async () => {
      ...
      try {
        ...
        toast.success('계약이 성공적으로 완료되었습니다!');
      } catch (error) {
              ...
              <div className="bg-green-50 p-6 rounded-lg space-y-4">
                ...
                <ul className="space-y-3 text-sm">
                  <li className="flex items-start gap-2">
                    <div className="w-6 h-6 rounded-full bg-green-600 text-white flex items-center justify-center text-xs flex-shrink-0 mt-0.5">
                      1
                    </div>
                    <span>전문가가 24시간 내에 연락을 드릴 예정입니다.</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="w-6 h-6 rounded-full bg-green-600 text-white flex items-center justify-center text-xs flex-shrink-0 mt-0.5">
                      2
                    </div>
                    <span>첫 상담 일정을 조율하게 됩니다.</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="w-6 h-6 rounded-full bg-green-600 text-white flex items-center justify-center text-xs flex-shrink-0 mt-0.5">
                      3
                    </div>
                    <span>계약서는 이메일로 전송됩니다.</span>
                  </li>
                </ul>
              </div>
