...
const PARTNER_INSTITUTIONS = [
  ...
  { id: 'inst_2', name: '{ id: 'inst_2', name: 'APA주간활동서비스센터', type: '발달센터', location: '본점', specialties: ['주간활동', '발달재활'], isVerified: true },', type: '발달센터', location: '본점', specialties: ['주관활동', '발달재활'], isVerified: true },
