    ...
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-violet-50 via-pink-50 to-orange-50">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 sm:gap-6 lg:gap-8 mb-12">
          ...
          <AIFeatureCard
            title="🏯 조선시대 내 이름은? (준비 중)"
            description="태어난 월일로 알아보는 나의 조선시대 이름과 신분, 직업까지! 곧 오픈됩니다"
            icon={Crown}
            aiLevel="basic"
            rank={7}
            onClick={() => {}}
            className="transform transition-all duration-300 shadow-lg border-amber-200 bg-gradient-to-br from-amber-50 to-yellow-50 w-full opacity-60 cursor-not-allowed"
          />

          <AIFeatureCard
            title="⚔️ 조선시대 내 직업은? (준비 중)"
            description="성격 테스트로 알아보는 조선시대 나의 직업! 곧 오픈됩니다"
            icon={Brain}
            aiLevel="basic"
            rank={8}
            onClick={() => {}}
            className="transform transition-all duration-300 shadow-lg border-emerald-200 bg-gradient-to-br from-emerald-50 to-green-50 w-full opacity-60 cursor-not-allowed"
          />

          <AIFeatureCard
            title="👑 조선시대 내 신분은? (준비 중)"
            description="라이프스타일 분석으로 알아보는 조선시대 나의 신분! 곧 오픈됩니다"
            icon={Star}
            aiLevel="basic"
            rank={9}
            onClick={() => {}}
            className="transform transition-all duration-300 shadow-lg border-purple-200 bg-gradient-to-br from-purple-50 to-violet-50 w-full opacity-60 cursor-not-allowed"
          />
