...
const allInstitutions = [
  ...
  { id: 'inst_2', name: 'APA주간활동서비스센터', type: '발달센터', location: '본점', specialties: ['주간활동', '발달재활'], description: '발달장애인을 위한 주간활동 서비스를 제공합니다.', phone: '010-9266-2710', hours: '평일 09:00 - 18:00' },, type: '발달센터', location: '본점', specialties: ['주간활동', '발달재활'], description: '발달장애인을 위한 주간활동 서비스를 제공합니다.', phone: '010-9266-2710', hours: '평일 09:00 - 18:00' },', type: '발달센터', location: '본점', specialties: ['주관활동', '발달재활'], description: '발달장애인을 위한 주관활동 서비스를 제공합니다.', phone: '010-9266-2710', hours: '평일 09:00 - 18:00' },
