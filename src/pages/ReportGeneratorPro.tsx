          ...
          <div className="max-w-5xl mx-auto space-y-6">
            ...
            <div id="report-content" className="bg-white rounded-2xl p-6 md:p-12 shadow-2xl space-y-8">
              ...
              <div className="pt-8 border-t-2 border-slate-200">
                <div className="bg-gradient-to-r from-primary/5 to-primary/10 p-6 rounded-2xl border border-primary/20 text-center space-y-3">
                  <h3 className="text-lg font-bold text-foreground">
                    {t('📤 가족·전문가에게 리포트 공유하기', '📤 Share Report with Family & Experts')}
                  </h3>
                  <p className="text-sm text-muted-foreground">
                    {t('영구 링크, 30일 한정, 1회성 링크 중 선택하여 안전하게 공유할 수 있습니다.',
                       'Choose permanent, 30-day, or one-time links to share securely.')}
                  </p>
                  <Button
