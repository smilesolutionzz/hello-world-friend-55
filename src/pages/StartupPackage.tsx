...
2. AI 분석 리포트: 14년 전문가 설계 빅데이터 엔진 기반 심층 분석 및 개인화된 리포트 자동 생성
...
- 심리검사: 30종 이상 탑재 완료
- AI 분석 엔진: 자체 개발 빅데이터 엔진 기반 리포트 자동 생성
...
- 발달검사 설계 및 AI 분석 시스템 구축
- 제품 기획·UX 전략·사업 전략 총괄
- 담당: 사업 총괄, 제품 로드맵, UX/UI 전략, 사용자 리서치, 서비스 품질 관리
...
- 기술 파트너: 클라우드 AI 인프라, Supabase, 토스페이먼츠
