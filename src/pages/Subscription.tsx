          ...
          <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-2xl p-8 border border-blue-100 shadow-lg">
            ...
            <div className="prose max-w-none text-gray-700 leading-relaxed">
              ...
              <div className="space-y-4 text-base">
                ...
                <p>
                  마음의 병은 보이지 않습니다. 우울한 청소년, 불안한 직장인, 치매 걱정에 잠 못 이루는 
                  어르신들... 모든 연령에서 심리적 어려움은 찾아옵니다. 하지만 지금까지 전문적인 
                  도움을 받기에는 비용도 부담스럽고, 시간도 오래 걸렸죠.
                </p>
                
                <p>
                  <strong>AIHPRO는 이 모든 것을 바꾸고 싶었습니다.</strong> 단 3분의 검사로 당신의 마음을 
                  이해하고, AI가 먼저 분석한 후 정말 필요할 때만 전문가에게 연결해드립니다. 
                  이렇게 하면 10분의 1 비용으로도 최고 수준의 심리 지원을 받을 수 있습니다.
                </p>
