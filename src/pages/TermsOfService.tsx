                  ...
                  <section>
                    ...
                    <div className="space-y-2 text-muted-foreground">
                      ...
                      <ul className="list-disc list-inside">
                        ...
                        <li><strong>30일 마음 변화 트랙:</strong> ₩19,900 일시불 (정가 ₩49,000, 60% 할인) — 30일간 모든 심층 검사·AI 분석 리포트·전문가 코칭 가이드 무제한, 자동 결제 없음</li>
                        <li><strong>전문가 1:1 상담:</strong> 40분 ₩49,000 / 80분 ₩79,000 (선택 이용)</li>
                        <li><strong>B2B 기관 솔루션:</strong> 별도 견적 (학교·발달센터·기업 대상)</li>
                      </ul>
                      <p>2. 결제는 토스페이먼츠를 통해 카드, 계좌이체, 휴대폰 결제로 가능합니다.</p>
                      <p>3. 30일 마음 변화 트랙은 일시불 결제 상품으로 자동 갱신되지 않습니다.</p>
