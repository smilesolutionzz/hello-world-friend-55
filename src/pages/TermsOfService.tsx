                ...
                <div className="space-y-6">
                  ...
                  <section>
                    ...
                    <div className="space-y-2 text-muted-foreground">
                      ...
                      <ul className="list-disc list-inside">
                        <li><strong>무료 체험:</strong> 비회원 및 신규 회원에게 일부 검사 무료 체험 제공</li>
                        <li><strong>단건 이용권:</strong> 검사 1회 ₩990, 심층 리포트 1회 ₩3,900</li>
                        <li><strong>월간 구독:</strong> ₩9,900/월 (모든 기능 무제한)</li>
                        <li><strong>연간 구독:</strong> ₩99,000/년 (모든 기능 무제한, 17% 할인)</li>
                        <li><strong>전문가 상담:</strong> 40분 ₩49,000 / 80분 ₩79,000</li>
                      </ul>
                      <p>2. 결제는 토스페이먼츠를 통해 카드, 계좌이체, 휴대폰 결제로 가능합니다.</p>
                      <p>3. 구독 결제 시 별도 해지 요청이 없는 한 자동으로 갱신됩니다.</p>
