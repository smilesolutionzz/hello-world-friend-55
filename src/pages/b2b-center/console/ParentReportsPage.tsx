            ...
            {loading ? <tr><td colSpan={5} className="p-8 text-center text-neutral-400">불러오는 중…</td></tr> :
             ...
             rows.map((r) => (
              <tr key={r.id} className="border-t border-neutral-100">
                ...
                <td className="p-3 text-right"><button className="inline-flex items-center gap-1 text-xs text-neutral-700 hover:text-neutral-900"><FileText className="w-3.5 h-3.5" /> 열기</button></td>
              </tr>
            ))}
          </tbody>
        </table>
