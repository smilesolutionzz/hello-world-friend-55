    ...
    const response = await fetch('https://ai.gateway.lovable.dev/v1/chat/completions', {
      ...
      body: JSON.stringify({
        ...
        messages: [
          {
            role: 'system',
            content: '당신은 ADHD 전문 정신과 의사로서, 과학적 근거에 바탕한 정확하고 상세한 임상 분석을 제공합니다. 최신 ADHD 연구를 바탕으로 전문적인 평가를 수행합니다. 반드시 3000자 이상의 상세한 분석을 제공하세요. 각 섹션별로 구체적인 근거와 함께 깊이 있는 해석을 제공하세요.'
          },
          {
            role: 'user',
