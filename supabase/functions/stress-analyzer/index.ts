...
다음 구조로 1500자 이상의 상세한 분석을 제공해주세요:
...
**6. 📋 요약 및 제언**
- **핵심 스트레스 상태 요약**: 현재 상태를 3-4줄로 명확하게 요약
- **즉시 실행 권장사항**: 오늘부터 바로 시작할 수 있는 3가지 스트레스 해소법
- **전문가 상담 필요성**: 추가 전문 도움이 필요한지 여부와 이유
- **희망적 전망**: 스트레스 개선 가능성과 격려의 한줄 메시지
