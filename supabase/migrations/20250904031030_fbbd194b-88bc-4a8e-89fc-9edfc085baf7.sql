-- Security fix: Remove any potential Security Definer views and recreate them properly
-- Views cannot have RLS directly, so we control access through proper WHERE clauses

-- Drop and recreate admin_overview_view without SECURITY DEFINER
...
-- Drop and recreate expert_stats_view without SECURITY DEFINER
...
-- Drop and recreate token_usage_view without SECURITY DEFINER
...
-- Drop and recreate user_dashboard_view without SECURITY DEFINER
