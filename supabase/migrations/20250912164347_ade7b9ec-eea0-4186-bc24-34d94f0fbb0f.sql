...
CREATE INDEX idx_therapy_institutions_name ON public.therapy_institutions USING gin(to_tsvector('simple', institution_name));
...
('충남아동발달센터', '발달재활서비스', '충청남도', '천안시', 'A', 20, 130, 4.6),
('경북언어치료소', '언어발달지원사업', '경상북도', '포항시', 'B', 14, 85, 4.4),
('경남돌봄네트워크', '가사간병방문지원사업', '경상남도', '창원시', 'A', 28, 175, 4.7),
('전남특수교육센터', '발달장애인 주간활동서비스', '전라남도', '목포시', 'C', 18, 65, 4.0),
('전북재활센터', '지역사회서비스투자', '전북특별자치도', '전주시', 'B', 24, 140, 4.5),
('제주아동복지관', '산모신생아건강관리지원', '제주특별자치도', '제주시', 'A', 16, 95, 4.6),
('세종발달지원센터', '발달장애학생 방과후활동서비스', '세종특별자치시', '세종시', 'B', 12, 70, 4.3);